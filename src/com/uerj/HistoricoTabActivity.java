...
public class HistoricoTabActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.historicotab);
			...
			public void onClick(View v) {
				...
				if(coManager.getAllNetworkInfo()[0].getState()==State.CONNECTED||coManager.getAllNetworkInfo()[1].getState()==State.CONNECTED) {
					if(txMatricula.getText().length()==12){
			    		...
			    		startActivity(new Intent(v.getContext(),HistoricoPageActivity.class));
			    		finish();
			    	}
			    	else{
