...
public class DisciplinasTabActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.disciplinastab);
			...
			public void onClick(View v) {
				...
				if(coManager.getAllNetworkInfo()[0].getState()==State.CONNECTED||coManager.getAllNetworkInfo()[1].getState()==State.CONNECTED) {
					if(txMatricula.getText().length()==12){
			    		...
			    		startActivity(new Intent(v.getContext(),DiscplinasPageActivity.class));
			    		finish();
			    	}
			    	else{
